 ...
 *
 * To successfully store and retrieve objects from a myHashtable, the
 * objects used as keys must implement the <code>hashCode</code>
 * method and the <code>equals</code> method. <p>
 *
 * An instance of <code>myHashtable</code> has two parameters that affect its
 ...
 * <tt>myHashtable</tt> operations, including <tt>get</tt> and <tt>put</tt>).<p>
 *
 * The initial capacity controls a tradeoff between wasted space and the
 * need for <code>rehash</code> operations, which are time-consuming.
 * No <code>rehash</code> operations will <i>ever</i> occur if the initial
 * capacity is greater than the maximum number of entries the
 * <tt>myHashtable</tt> will contain divided by its load factor.  However,
 ...
 *
 * This example creates a myHashtable of numbers. It uses the names of
 * the numbers as keys:
 * <pre>   {@code
 *   myHashtable<String, Integer> numbers
 *     = new myHashtable<String, Integer>();
 *   numbers.put("one", 1);
 *   numbers.put("two", 2);
 ...
 * <em>fail-fast</em>: if the myHashtable is structurally modified at any time
 ...
 * The Enumerations returned by myHashtable's keys and elements methods are
 * <em>not</em> fail-fast.
 *
 ...
 * implement the {@link java.util.Map} interface, making it a member of the
 * <a href="{@docRoot}/../technotes/guides/collections/index.html">
 *
 * Java Collections Framework</a>.  Unlike the new collection
 * implementations, {@code myHashtable} is synchronized.  If a
 * thread-safe implementation is not needed, it is recommended to use
 * {@link java.util.HashMap} in place of {@code myHashtable}.  If a thread-safe
...
/**
     ...
     * sequentially.
     *
     * @return  an enumeration of the values in this myHashtable.
     * @see     java.util.Enumeration
     * @see     #keys()
     * @see     #values()
     * @see     Map
...
/**
     ...
     *             <code>value</code> argument in this myHashtable as
...
/**
     ...
     *
     * @param value value whose presence in this myHashtable is to be tested
...
/**
     ...
     *          is a key in this myHashtable, as determined by the
...
/**
     ...
     *
     * @param      key     the myHashtable key
     * @param      value   the value
     * @return     the previous value of the specified key in this myHashtable,
    ...
    public synchronized V put(K key, V value) {
        ...
        // Makes sure the key is not already in the myHashtable.
        Entry tab[] = table;
        int hash = hash(key);
        int index = (hash & 0x7FFFFFFF) % tab.length;
        for (Entry<K,V> e = tab[index] ; e != null ; e = e.next) {
...
/**
     ...
     *
     * @param  o object to be compared for equality with this myHashtable
...
/**
     ...
     *             <i>size</i> of the myHashtable (the number of key-value
