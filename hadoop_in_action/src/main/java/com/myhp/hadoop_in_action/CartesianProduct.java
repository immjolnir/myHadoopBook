...
public class CartesianProduct {
    public static final Log log = LogFactory.getLog(CartesianProduct.class);

	public static class CartesianInputFormat extends FileInputFormat {
        static {
            log.info("class \"CartesianInputFormat\" is called");
        }
		...
		public InputSplit[] getSplits(JobConf conf, int numSplits)
				throws IOException {
            log.info("method \"CartesianInputFormat::getSplits()\" is called");
			try {
		...
		public RecordReader getRecordReader(InputSplit split, JobConf conf,
            ...
            log.info("method \"CartesianInputFormat::getRecordReader()\" is called");
		...
		private InputSplit[] getInputSplits(JobConf conf,
            ...
            log.info("method \"CartesianInputFormat::getInputSplits()\" is called");
	...
	public static class CartesianRecordReader<K1, V1, K2, V2> implements
        ...
        static {
            log.info("class \"CartesianRecordReader\" is called");
        }
		...
		public CartesianRecordReader(CompositeInputSplit split, JobConf conf,
				Reporter reporter) throws IOException {
            log.info("method \"CartesianRecordReader::CartesianRecordReader()\" is called");
		...
		public Text createKey() {
            log.info("method \"CartesianRecordReader::createKey()\" is called");
			return new Text();
		}

		@Override
		public Text createValue() {
            log.info("method \"CartesianRecordReader::createValue()\" is called");
			return new Text();
		}

		@Override
		public long getPos() throws IOException {
            log.info("method \"CartesianRecordReader::getPos()\" is called");
			return leftRR.getPos();
		}

		@Override
		public boolean next(Text key, Text value) throws IOException {
            log.info("method \"CartesianRecordReader::next()\" is called");
		...
		public void close() throws IOException {
            log.info("method \"CartesianRecordReader::close()\" is called");
			leftRR.close();
			rightRR.close();
		}
		...
		public float getProgress() throws IOException {
            log.info("method \"CartesianRecordReader::getProgress()\" is called");
	...
	public static class CartesianMapper extends MapReduceBase implements
        ...
        static {
            log.info("class \"CartesianMapper\" is called");
        }
		...
		public void map(Text key, Text value,
				...
				throws IOException {
            log.info("method \"CartesianMapper::map()\" is called");
	...
	public static void main(String[] args) throws IOException,
        ...
        log.info("method main() is called");
